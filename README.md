...
The Choregraphe software installer is then downloaded to your computer. Now you need to run it to install it. This is illustrated by the screenshot below:
