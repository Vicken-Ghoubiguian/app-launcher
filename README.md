...
If an app-launcher is installed on your Pepper robot, you must remove it. How ? Very simple. As shown in the screenshot below, you must select the app-launcher application in the "Robot application" menu then click on the button :
